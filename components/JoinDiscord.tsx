...
const DISCORD_INVITE = "https://discord.gg/highcode"
...
export default function JoinDiscord() {
    const { memberCount, presenceCount } = useDiscordStats()
    const formattedMembers = memberCount.toLocaleString("en-US")
    return(
                ...
                <div className="flex flex-col items-center gap-1 pt-1">
                  ...
                  {presenceCount > 0 && (
                    <div className="flex items-center gap-2 text-sm text-gray-300">
                      ...
                      {presenceCount.toLocaleString("en-US")} online now
                    </div>
                  )}
                </div>
              </div>
