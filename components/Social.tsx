...
const socialMedia = [
  ...
  },
  {
    ...
    url: "https://github.com/HighCodeh",
    handle: "@HighCodeh",
    followers: "422 membros",
    posts: [
      "/d.jpeg",
      "/d2.jpeg",
      "/d3.jpeg"
  ...
  return (
    <section className="py-24 relative bg-black overflow-hidden" id="social">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-[#8C2AFF]/10 rounded-full filter blur-[120px]"></div>
        <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-[#4a1e99]/10 rounded-full filter blur-[100px]"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Acompanhe nossa jornada e faça parte da comunidade High Boy
          </motion.p>
        </div>
                ...
                {social.posts.map((post, postIndex) => (
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10 opacity-0 hover:opacity-100 transition-opacity flex items-end p-3">
                      <span className="text-white text-sm font-medium">Post #{postIndex + 1}</span>
                    </div>
                    <div 
